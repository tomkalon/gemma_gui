 ...
 */
final class Version20230315161148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE objects (id INT AUTO_INCREMENT NOT NULL, settings_id INT NOT NULL, name VARCHAR(255) NOT NULL, temp VARCHAR(255) DEFAULT NULL, temp2 VARCHAR(255) DEFAULT NULL, humid VARCHAR(255) DEFAULT NULL, vent VARCHAR(255) DEFAULT NULL, shadow VARCHAR(255) DEFAULT NULL, blow VARCHAR(255) DEFAULT NULL, heat VARCHAR(255) DEFAULT NULL, INDEX IDX_B21ACCF359949888 (settings_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE settings (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, temp_day VARCHAR(255) DEFAULT NULL, temp_night VARCHAR(255) DEFAULT NULL, temp_hysteresis VARCHAR(255) DEFAULT NULL, temp_control_day TINYINT(1) DEFAULT NULL, temp_control_night TINYINT(1) DEFAULT NULL, temp_vent_close VARCHAR(255) DEFAULT NULL, temp_alarm VARCHAR(255) DEFAULT NULL, temp_alarm_flag VARCHAR(255) DEFAULT NULL, humid VARCHAR(255) DEFAULT NULL, humid_hysteresis VARCHAR(255) DEFAULT NULL, humid_control_day TINYINT(1) DEFAULT NULL, humid_control_night TINYINT(1) DEFAULT NULL, humid_vent_step VARCHAR(255) DEFAULT NULL, humid_vent_pause VARCHAR(255) DEFAULT NULL, humid_vent_pause_open VARCHAR(255) DEFAULT NULL, humid_vent_max_open VARCHAR(255) DEFAULT NULL, humid_alarm VARCHAR(255) DEFAULT NULL, humid_alarm_flag TINYINT(1) DEFAULT NULL, humid_alarm_enable TINYINT(1) DEFAULT NULL, heat VARCHAR(255) DEFAULT NULL, heat_hysteresis VARCHAR(255) DEFAULT NULL, vent VARCHAR(255) DEFAULT NULL, vent_step_time VARCHAR(255) DEFAULT NULL, vent_pause VARCHAR(255) DEFAULT NULL, vent_open_close_time VARCHAR(255) DEFAULT NULL, vent_max_open_rain VARCHAR(255) DEFAULT NULL, vent_wind_delay VARCHAR(255) DEFAULT NULL, vent_rain_delay VARCHAR(255) DEFAULT NULL, vent_weak_wind_max VARCHAR(255) DEFAULT NULL, vent_strong_wind_max VARCHAR(255) DEFAULT NULL, vent_min_temp VARCHAR(255) DEFAULT NULL, blow VARCHAR(255) DEFAULT NULL, blow_pause VARCHAR(255) DEFAULT NULL, shadow VARCHAR(255) DEFAULT NULL, shadow_manual VARCHAR(255) DEFAULT NULL, shadow1 VARCHAR(255) DEFAULT NULL, shadow2 VARCHAR(255) DEFAULT NULL, shadow3 VARCHAR(255) DEFAULT NULL, shadow4 VARCHAR(255) DEFAULT NULL, shadow5 VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stats (id INT AUTO_INCREMENT NOT NULL, object_id INT NOT NULL, temp VARCHAR(255) DEFAULT NULL, temp2 VARCHAR(255) DEFAULT NULL, humid VARCHAR(255) DEFAULT NULL, vent VARCHAR(255) DEFAULT NULL, shadow VARCHAR(255) DEFAULT NULL, blow VARCHAR(255) DEFAULT NULL, heat VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, INDEX IDX_574767AA232D562B (object_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
