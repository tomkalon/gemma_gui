 ...
 */
final class Version20230315165047 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE objects (id INT AUTO_INCREMENT NOT NULL, settings_id INT NOT NULL, name VARCHAR(255) NOT NULL, temp VARCHAR(255) DEFAULT NULL, humid VARCHAR(255) DEFAULT NULL, vent VARCHAR(255) DEFAULT NULL, shadow VARCHAR(255) DEFAULT NULL, blow VARCHAR(255) DEFAULT NULL, heat VARCHAR(255) DEFAULT NULL, INDEX IDX_B21ACCF359949888 (settings_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
